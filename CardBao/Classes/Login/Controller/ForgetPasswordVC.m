...
-(void)getUI {
   ...
   NSArray *plArray    = @[@"请输入注册手机号码",@"请输入验证码",@"请设置新密码,6-16数字、字母或符号组成"];
    ...
    // 自定义导航栏
    [self setNavigationViewTitle:@"忘记密码" hiddenBackButton:NO backgroundColor:nil];
...
-(void)getCodeClick:(UIButton*)sender {
    ...
    [[RequestManager shareInstance] postWithURL:GETCODE_INTERFACE parameters:@{@"account":phoneText.text,@"type":@3} isLoading:YES loadTitle:@"发送中..." addLoadToView:self.view andWithSuccess:^(RequestManager * _Nonnull manage, id  _Nonnull model) {
